(function(context) {
    ...
    context.vCard = vCard
            ...
            var all = [{
                ...
                "fn": "John2 Smith2",
                "nickname":"js2",
                "title": "Missing man too2",
                "tel": [
                    {"value": "555-555-5552", "type": "cell"}
                ],
                "email": [
                    { "value": "john.smith2@work.com", "type": "work" },
                    { "value": "john.smith2@home.com", "type": "home" }
                ]
            }            
            ]
            ...
            document.getElementById("myButton").addEventListener("click", () => {
                ...
                var link = vCard.export(all, "all vcards", false) // use parameter true to force download
